    ...
    stages {
        ...
        stage('Git prod'){
            ...
            steps{
                ...
                checkout([$class: 'GitSCM', branches: [[name: '*/prod']], extensions: [], userRemoteConfigs: [[credentialsId: 'github-multi', url: 'https://github.com/naveenkumar2412/jenkins-cicd.git']]])
