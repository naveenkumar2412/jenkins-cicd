    ...
    stages {
        ...
        stage('Git Staging'){
            ...
            steps{
                ...
                checkout([$class: 'GitSCM', branches: [[name: '*/main']], extensions: [], userRemoteConfigs: [[credentialsId: 'github-multi', url: 'https://https://github.com/naveenkumar2412/jenkins-cicd']]])
