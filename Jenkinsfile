    ...
    stages {
        ...
        stage('Git stage'){
            ...
            steps{
                ...
                checkout([$class: 'GitSCM', branches: [[name: '*/stage']], extensions: [], userRemoteConfigs: [[credentialsId: 'github-multi', url: 'https://https://github.com/naveenkumar2412/jenkins-cicd']]])
