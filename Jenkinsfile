    ...
    stages {
        ...
        stage('Git main'){
            ...
            steps{
                ...
                checkout([$class: 'GitSCM', branches: [[name: '*/main']], extensions: [], userRemoteConfigs: [[credentialsId: 'github-multi', url: 'https://github.com/naveenkumar2412/jenkins-cicd.git']]])
